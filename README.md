...
# Текущий статус 🗿
  [:heavy_check_mark:] Библиотека в рабочем состоянии (06.11.2021). </br>
  [:warning:] Главный разработчик покинул проект. Обновлений библиотеки **больше не будет**. Все открытые pull requests и issues останутся **без изменений**.
